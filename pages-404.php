            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center error-pages">
                        <h1 class="error-title text-primary"> 01001</h1>
                        <h2 class="error-sub-title text-white">La página solicitada aún no está programada</h2>

                        <p class="error-message text-white text-uppercase">Lo siento, Ha ocurrido un error, la página solicitada no se encuentra!</p>
                        
                        <div class="mt-4">
                          <a href="index.php" class="btn btn-primary btn-round shadow-primary m-1">Vuelve despúes </a>
                          <a href="javascript:void();" class="btn btn-outline-primary btn-round m-1">Devolver</a>
                        </div>

                        <div class="mt-4">
                            <p class="text-light"><span class="text-primary">Acceso Z </span>| Todos los derechos reservados.</p>
                        </div>
                           <hr class="w-50">
                        <div class="mt-2">
